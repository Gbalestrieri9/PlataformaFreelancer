...
public class CarteiraController {
    ...
    @PostMapping("/v1/visualizar-saldo")
    public ResponseEntity<?> visualizarSaldo(@RequestParam String documento){
        LoggerUtils.logRequestStart(LOGGER, "visualizarSaldo", documento);

        long startTime = System.currentTimeMillis();

        ResponseSaldoCarteiraDBDTO response = carteiraService.visualizarSaldo(documento);
