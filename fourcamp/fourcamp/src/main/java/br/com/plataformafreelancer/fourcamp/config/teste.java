...
@Component
public class teste extends OncePerRequestFilter {
...
//        return request.getHeader("tipoUsuario") != null
//                && !request.getHeader("tipoUsuario").isBlank()
//                && request.getHeader("email") != null
...
//    private void sendBadRequestResponse(HttpServletResponse response, HttpServletRequest request, String message,
//                                        String code) throws IOException {
//        response.setStatus(HttpStatus.BAD_REQUEST.value());
//        response.setContentType(MediaType.APPLICATION_JSON_VALUE);
//        response.getWriter().write(objectMapper.writeValueAsString(
//                new ErrorResponse(message, request.getServletPath(), HttpStatus.BAD_REQUEST.value(), code)));
//    }
//
//    private void sendForbiddenResponse(HttpServletResponse response, HttpServletRequest request, String message,
//                                       String code) throws IOException {
//        response.setStatus(HttpStatus.FORBIDDEN.value());
//        response.setContentType(MediaType.APPLICATION_JSON_VALUE);
//        response.getWriter().write(objectMapper.writeValueAsString(
//                new ErrorResponse(message, request.getServletPath(), HttpStatus.FORBIDDEN.value(), code)));
//    }
}